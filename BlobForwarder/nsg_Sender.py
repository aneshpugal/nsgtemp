...
def get_timestamp(datetime_string):
    try:
        datetime_data = datetime.datetime.strptime(datetime_string[:-2]+datetime_string[-1], s247_datetime_format_string)
...
def json_log_parser(lines_read):
    ...
    for event_obj in lines_read:
        try:
            ...
            formatted_line['s247agentuid'] = "nsg"
